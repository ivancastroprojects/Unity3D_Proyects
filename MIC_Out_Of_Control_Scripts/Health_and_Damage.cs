...
public class Health_and_Damage : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (endTimeText == null)
            endTimeText = GameManager.manager.endTimeText;
    ...
    public void RestarVida(float damage)
    {
        ...
        barraDeVida = GameManager.manager.barraVida;
            ...
            Debug.Log("conv" + converted);
            Debug.Log("barravida" + barraDeVida.fillAmount);
            Debug.Log("inv " + invencible);
    ...
    public void GameOver()
    {
        ...
        endGameText.transform.GetChild(0).GetComponent<Button>().onClick.AddListener(RespawnLife);
    ...
    public void GameOverTime()
    {
        ...
        Time.timeScale = 0;
        endTimeText.transform.GetChild(0).GetComponent<Button>().onClick.AddListener(RespawnTime);
