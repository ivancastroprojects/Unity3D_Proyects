...
public class DialogueManager : MonoBehaviour
{
    ...
    public void DisplayNextSentence()
    {
        ...
        if (GameManager.manager.GetToTextQuest() == "Horror in build MIC" && thisNPC.name == "guardscientist")
        {
        ...
        if (GameManager.manager.GetToTextQuest() == "Without light and without defenses" && thisNPC.name == "guardscientist")
        {
